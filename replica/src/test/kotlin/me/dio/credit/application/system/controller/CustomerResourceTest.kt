...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Neves"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("12345678909"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("sgtrailson@gmail.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("2300.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua A, 12"))
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("JoaoUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("NevesUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("12345678909"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("sgtrailson@gmail.com"))
    ...
    private fun builderCustomerDto(
        ...
        lastName: String = "Neves",
        cpf: String = "12345678909",
        email: String = "sgtrailson@gmail.com",
        income: BigDecimal = BigDecimal.valueOf(1000.0),
        password: String = "1234",
        zipCode: String = "000000",
        street: String = "Rua A, 12",
    ) = CustomerDto(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "JoaoUpdate",
        lastName: String = "NevesUpdate",
